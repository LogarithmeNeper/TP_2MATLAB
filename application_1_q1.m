%Donner les 50 valeurs propres de plus petit module
...
fprintf("50 premières valeurs propres de plus petit module:\n")

for i=1:50
    [lambda_z, u, Z] = deflation_wielandt(Z, epsilon);
    lambda = 1 / lambda_z;
    fprintf("\t%f\n", lambda)
    
    if(afficher_graphiques)
        close all;
        tracer_graphique(u, lambda, "(Valeurs propres de plus petit module)");
